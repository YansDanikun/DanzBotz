...
require('./Danzuko.js')
nocache('../Danzuko.js', module => console.log(color('[ CHANGE ]', 'green'), color(`'${module}'`, 'green'), 'Updated'))
require('./index.js')
...
console.log(color(figlet.textSync(`DanzukoBotz`, {
font: 'Standard',
...
require('./Danzuko')(XeonBotInc, m, chatUpdate, store)
} catch (err) {
console.log(err)}})
...
ppgroup = 'https://chat.whatsapp.com/CvdJmhR93EX80nvngEAtmv'
}
			console.log(json)
			const res = json[0];
...
"body": `${ownername}`,
 "previewType": "PHOTO",
"thumbnailUrl": `https://ibb.co/jRFkMS6`,
"thumbnail": XeonWlcm,
"sourceUrl": `${wagc}`}}})
